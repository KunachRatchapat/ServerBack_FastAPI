...
class NutritionService:
    ...
    def get_by_vegetable(self, db: Session, vegetable_id: int) -> NutritionResponse:
        ...
        if not obj:
            raise NotFoundError("Nutrition not found for this vegetable")
        return NutritionResponse.model_validate(obj)
