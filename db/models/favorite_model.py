...
class Favorite(SQLModel, table=True):
    ...
    vegetable_id: Optional[int] = Field(
        default=None, foreign_key="vegetable.id"
    )  # เอา vegetable.id จากตาราง Vegetable
    fruit_id: Optional[int] = Field(
        default=None, foreign_key="fruit.id"
    )  # เอา fruit.id จากตาราง Fruit
